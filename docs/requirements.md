...
2.  **VPN:** WireGuard/OpenVPN via **stock GL.iNet** UI; this project references the tunnel interface in **`privacy.main.wg_if`** for the watchdog (no bundled VPN provisioning).
